...
import { ProducerOnboardComponent } from './producer-onboard.component';
...
describe('ProducerOnboardComponent', () => {
  let component: ProducerOnboardComponent;
  let fixture: ComponentFixture<ProducerOnboardComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(ProducerOnboardComponent);
  ...
  it('should initialize the form with required controls', () => {
    expect(component.form.get('productionHouse')).toBeTruthy();
  ...
  it('should mark form as valid when properly filled', () => {
    component.form.patchValue({
      productionHouse: 'Production Company',
  ...
  it('should register producer when form is submitted', fakeAsync(() => {
    // Arrange
    component.form.patchValue({
      productionHouse: 'Production Company',
      location: 'Mumbai, Maharashtra',
  ...
  it('should handle OTP verification', () => {
    ...
    spyOn(component, 'onOtpVerified');
    
    // Act
    component.onOtpVerified(otpValue);
    
    // Assert
    expect(component.onOtpVerified).toHaveBeenCalledWith(otpValue);
  });
});
