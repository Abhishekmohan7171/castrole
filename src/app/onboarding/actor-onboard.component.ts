            ...
            <div class="flex gap-2">
              ...
              <div class="relative flex-1">
                ...
                <input
                  ...
                  class="w-full bg-neutral-800/80 text-neutral-200 placeholder-neutral-500 rounded-full pl-12 pr-4 py-3 outline-none ring-1 ring-white/10 focus:ring-2 focus:ring-emerald-500/50 transition disabled:opacity-75"
                />
                <!-- Verified tick -->
